...
public class AutoDriveAprilTag extends LinearOpMode
{
    ...
    @Override public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.addLine("currentDetections size:"+ currentDetections.size());

            for (AprilTagDetection detection : currentDetections) {
                telemetry.addLine("DESIRED_TAG_ID :"+ DESIRED_TAG_ID +",detection.id: "+detection.id);
            ...
            telemetry.addLine("desiredTag:"+ desiredTag);
